...
* [ioBroker node-red Adapter](https://github.com/ioBroker/ioBroker.node-red) ⭐ 53 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-22 - Starts an instance within ioBroker and communicates with it.
...
* [huemagic](https://github.com/Foddy/node-red-contrib-huemagic) ⭐ 204 | 🐛 1 | 🌐 HTML | 📅 2026-09-19 - Controls Philips Hue bridges, lights, groups, scenes, rules, taps, switches, buttons, motion sensors, temperature sensors and Lux sensors.
