...
* [huemagic](https://github.com/Foddy/node-red-contrib-huemagic) ⭐ 202 | 🐛 0 | 🌐 HTML | 📅 2026-08-18 - Controls Philips Hue bridges, lights, groups, scenes, rules, taps, switches, buttons, motion sensors, temperature sensors and Lux sensors.
...
* [telegrambot](https://github.com/windkh/node-red-contrib-telegrambot) ⭐ 301 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-18 - Contains a receiver and a sender node which act as a Telegram Bot.
