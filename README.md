...
* [RedMatic](https://github.com/rdmtc/RedMatic/wiki/Installation) ⭐ 532 | 🐛 165 | 🌐 Shell | 📅 2026-09-02 - Install Node-RED on a CCU3, smart home automation hardware from the manufacturer eQ-3, popular especially in Germany.
...
* [stackhero-mysql](https://github.com/stackhero-io/node-red-contrib-stackhero-mysql) ⭐ 19 | 🐛 2 | 🌐 HTML | 📅 2026-09-02 - Connect to a MySQL or a MariaDB database, using TLS (SSL) and compatible with "Caching SHA2 password" authentication method (MySQL >= 8).
