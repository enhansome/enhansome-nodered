...
* [RedMatic](https://github.com/rdmtc/RedMatic/wiki/Installation) ⭐ 529 | 🐛 1 | 🌐 Shell | 📅 2026-09-06 - Install Node-RED on a CCU3, smart home automation hardware from the manufacturer eQ-3, popular especially in Germany.
...
* [ccu](https://github.com/rdmtc/node-red-contrib-ccu) ⭐ 69 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-06 - Connect with Homematic, a series of smart home automation hardware from the manufacturer eQ-3, popular especially in Germany.
...
* [telegrambot](https://github.com/windkh/node-red-contrib-telegrambot) ⭐ 300 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-06 - Contains a receiver and a sender node which act as a Telegram Bot.
